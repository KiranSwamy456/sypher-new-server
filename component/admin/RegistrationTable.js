  ...
  },
 {
      ...
      cell: row => (
        <div className="action-buttons">
          ...
          <button
            className="btn btn-sm btn-outline-success tooltip-btn"
          ...
          <button
            className="btn btn-sm btn-outline-info tooltip-btn"
          ...
          {row.status === 0 && (
            <button
              className="btn btn-sm btn-outline-warning tooltip-btn"
              title="Convert to Student"
              onClick={() => handleConvertToStudent(row.id, row.student_name)}
            >
