...
const services = [
  {
    ...
    desc: "Our method is based on cognitive load theory and spaced repetition, helping students learn smarter, not just harder.",
    color: "red",
    className: "tf__popular_service_single" // This should be the main class for each card
  },
  {
    id: 1,
    iClassName: "fa fa-rocket",
    title: "Beyond the Standards",
    desc: "We go 20-30% beyond the NC State curriculum to prepare students for top competitions like Math Bowl and Science Fairs.",
    color: "gray",
    className: "tf__popular_service_two"
  },
  {
    id: 2,
    iClassName: "fa fa-user",
    title: "Personalized Learning",
    desc: "We create customized plans for each student based on their unique learning style and neural patterns.",
    color: "green",
    className: "tf__popular_service_three"
  },
  {
    id: 3,
    iClassName: "fa fa-wrench",
    title: "Real-World Skills",
    desc: "We focus on applying knowledge to real-world problems, ensuring long-term retention and true understanding.",
    color: "blue",
    className: "tf__popular_service_four"
  }
];
